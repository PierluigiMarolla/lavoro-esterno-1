"""Connettore scraper stub per la fonte "PunterForum".
...
class PunterforumScraper(Scraper):
    slug = "punterforum"
    base_url = "https://www.punterforum.com"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per PunterForum, rispettando ToS e rate limit"
        )
