"""Connettore scraper stub per la fonte "Torino Erotica".
...
class TorinoEroticaScraper(Scraper):
    slug = "torino_erotica"
    base_url = "https://www.torinoerotica.com"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per Torino Erotica, rispettando ToS e rate limit"
        )
