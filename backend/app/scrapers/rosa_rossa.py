"""Connettore scraper stub per la fonte "Rosa Rossa".
...
class RosaRossaScraper(Scraper):
    slug = "rosa_rossa"
    base_url = "https://www.rosa-rossa.com"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per Rosa Rossa, rispettando ToS e rate limit"
        )
