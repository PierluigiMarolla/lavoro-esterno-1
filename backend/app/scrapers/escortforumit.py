"""Connettore scraper stub per la fonte "EscortForumIt".
...
class EscortforumitScraper(Scraper):
    slug = "escortforumit"
    base_url = "https://www.escortforumit.xxx"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per EscortForumIt, rispettando ToS e rate limit"
        )
