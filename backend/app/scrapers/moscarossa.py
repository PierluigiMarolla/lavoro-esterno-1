"""Connettore scraper stub per la fonte "Moscarossa".
...
class MoscarossaScraper(Scraper):
    slug = "moscarossa"
    base_url = "https://www.moscarossa.com"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per Moscarossa, rispettando ToS e rate limit"
        )
