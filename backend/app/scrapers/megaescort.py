"""Connettore scraper stub per la fonte "Megaescort".
...
class MegaescortScraper(Scraper):
    slug = "megaescort"
    base_url = "https://www.megaescort.com"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per Megaescort, rispettando ToS e rate limit"
        )
