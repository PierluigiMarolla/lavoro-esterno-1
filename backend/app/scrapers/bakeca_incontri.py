"""Connettore scraper stub per la fonte "Bakeca Incontri".
...
class BakecaIncontriScraper(Scraper):
    slug = "bakeca_incontri"
    base_url = "https://www.bakecaincontrii.com"
    rate_limit_seconds = 2.0

    async def discover(self) -> list[str]:
        raise NotImplementedError(
            "TODO: implementare scraping reale per Bakeca Incontri, rispettando ToS e rate limit"
        )
