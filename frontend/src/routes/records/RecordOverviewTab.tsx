        ...
        <section className="bg-surface-container-lowest border border-border rounded-lg shadow-sm">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div>
                <label className="text-label-sm text-on-surface-variant block mb-1">Phone</label>
                <div className="text-body-md text-on-surface font-mono">{record.phone}</div>
              </div>
              <div>
                <label className="text-label-sm text-on-surface-variant block mb-1">Confidence Score</label>
              ...
              <div>
                <label className="text-label-sm text-on-surface-variant block mb-1">Record Status</label>
                <Badge tone={STATUS_TONE[record.status] ?? "neutral"}>
                  {STATUS_LABEL[record.status] ?? record.status}
                </Badge>
              </div>
              <div>
                <label className="text-label-sm text-on-surface-variant block mb-1">Last Seen</label>
        ...
        <div className="bg-surface-container-lowest border border-border rounded-lg shadow-sm p-5">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 border border-border rounded-md">
              ...
              <div>
                <div className="text-label-sm text-on-surface-variant">Phone Number</div>
            ...
            <div className="flex items-center gap-3 p-3 border border-border rounded-md">
              ...
              <div>
                <div className="text-label-sm text-on-surface-variant">Unique Sources</div>
                <div className="text-body-md font-medium text-on-surface">{record.sourcesCount} Sources</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 border border-border rounded-md">
              ...
              <div>
                <div className="text-label-sm text-on-surface-variant">Occurrences</div>
                <div className="text-body-md font-medium text-on-surface">{record.occurrencesCount} Total</div>
              </div>
            </div>
          </div>
        </div>
